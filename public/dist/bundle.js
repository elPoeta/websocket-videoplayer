...
function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function togglePlay() {
      ...
      socket.getConnection().emit(method, {
        message: method
      });
    }
  }, {
    ...
    value: function skip(e) {
      socket.getConnection().emit("skip", {
    ...
    value: function backForward(e) {
      ...
      socket.getConnection().emit("backForward", {
        message: time
      });
    }
  }]);
...
/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(socket_io_client__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _videoPlayer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(0);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  function Connection() {
    ...
    this.socket = socket_io_client__WEBPACK_IMPORTED_MODULE_1___default.a.connect(_util_js__WEBPACK_IMPORTED_MODULE_0__["WS_URL"]);
  ...
  _createClass(Connection, [{
    ...
    key: "handlerMessagesIo",
    value: function handlerMessagesIo() {
      this.socket.on('playOk', function (data) {
        _videoPlayer_js__WEBPACK_IMPORTED_MODULE_2__["default"].video[data.message]();
      });
      this.socket.on('pauseOk', function (data) {
        _videoPlayer_js__WEBPACK_IMPORTED_MODULE_2__["default"].video[data.message]();
      });
      this.socket.on('skipOk', function (data) {
        _videoPlayer_js__WEBPACK_IMPORTED_MODULE_2__["default"].video.currentTime += parseFloat(data.message);
      });
      this.socket.on('backForwardOk', function (data) {
        _videoPlayer_js__WEBPACK_IMPORTED_MODULE_2__["default"].video.currentTime = parseFloat(data.message);
      });
    }
  }]);
